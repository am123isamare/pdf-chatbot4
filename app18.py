...
# Initialize session state to store the PDF text and file name
...
if user_input:
    ...
    with st.chat_message("assistant"):
        ...
        for res in response:
            # Check if res is an instance of AIMessageChunk or any similar class
            if isinstance(res, str):
                full_response += res
            elif hasattr(res, 'content'):  # Assuming the chunk has a 'content' attribute
